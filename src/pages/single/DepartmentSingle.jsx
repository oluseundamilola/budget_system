  ...
  return (
    <div className="single">
      ...
      <div className="singleContainer">
        ...
        <div className="top">
          <div className="left">
            <Link to={`/division/new/${department_id}`}>
              <div className="editButton">Create Division</div>
            </Link>
            <h1 className="title">Information</h1>
            <div className="item">
              <div className="itemImg">Department</div>
              <div className="details">
                <h1 className="itemTitle">{departmentInfo.name}</h1>
                <div className="detailItem">
                  <span className="itemKey">Ministry Name:</span>
                  <span className="itemValue">
                    {departmentInfo.ministryName}
                  </span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">Number of Divisions:</span>
                  <span className="itemValue">
                    {departmentInfo.divisionCount}
                  </span>
                </div>
                <div className="detailItem">
