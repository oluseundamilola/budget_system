...
import { DepartmentInput, RequestInput, ministyInput } from "./formSource";
        ...
        <Routes>
          <Route path="/">
            ...
            <Route path="requests">
              ...
              <Route path=":division_id" element = {<RequireAuth loginPath='/login'><DivisionSingle /></RequireAuth>  } />
              <Route path="new/:division_id" element = {<RequireAuth loginPath='/login'><New inputs={RequestInput} title="Create Request" /></RequireAuth>  } />
            </Route>
